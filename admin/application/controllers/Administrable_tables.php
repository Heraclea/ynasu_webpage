...
class Administrable_tables extends CI_Controller {
	...
	function order_records(){
		...
		$this->administrable_table_model->order_records_table($table, $records);
	...
	function delete_field_file(){
		$this->administrable_table_model->delete_field_files($this->input->post());
