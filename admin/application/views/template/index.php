...
<body> 
    <div class="wrapper">
        ...
        <div class="sidebar" data-color="black" data-image="<?= base_url() ?>assets/images/sidebar-heraclea.jpg">    
        	<div class="sidebar-wrapper">
                <div class="logo">
                    <a href="http://heracleaweb.com" target="_blank" class="simple-text">
                        Ynasu
                    </a>
                </div>
                ...
                <ul class="nav">
                    ...
                    <li>
                        ...
                        <ul class="sub nav">
                            <?php $tables = adminsitrable_tables(); 
                                foreach (make_menu($tables) as $table) { ?>
                                    <?php if (isset($table->submenu)) { ?> 
                                        <li>
                                            <a data-toggle="collapse" href="#<?= $table->name ?>" class="collapsed" aria-expanded="false">
                                                <p><?= ucfirst(str_replace('_', ' ', $table->name)) ?>
                                                   <b class="caret pull-right" style="margin-top: 13px;"></b>
                                                </p>
                                            </a>
                                            <div class="collapse submenu" id="<?= $table->name ?>" aria-expanded="false" style="height: 0px;">
                                                <ul class="nav">
                                                    <?php if($table->visible){ ?>
                                                        <li>
                                                            <a href="<?= base_url() ?>administrable_tables/view/<?= $table->name ?>"><?= ucfirst(str_replace('_', ' ', $table->name)) ?></a>
                                                        </li>
                                                    <?php } ?>

                                                    <?php foreach ($table->submenu as $submenu) { ?>
                                                        <li>
                                                            <a href="<?= base_url() ?>administrable_tables/view/<?= $submenu->name ?>"><?= ucfirst(str_replace('_', ' ', $submenu->name)) ?></a>
                                                        </li>
                                                    <?php } ?>
            ...
            <footer class="footer">
                <div class="container-fluid">
                    <p class="copyright pull-right">
                        &copy; 2017 <a href="http://heracleaweb.com" target="_blank">Heraclea</a>. No desarrollamos ¡Construimos!
                    </p>
                </div>
            </footer>
            <?php } ?>
