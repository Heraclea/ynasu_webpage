                    ...
                    <div class="content">
                        <form onkeypress="return event.keyCode != 13;">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>Emals de contacto<small></label><br>
                                        <input type="text" class="save-input form-control" data-role="tagsinput" name="contact_emails" placeholder="<?= $this->lang->line('contact_emails') ?>" value="<?= $configuration->contact_emails ?>">
                                    </div>        
                                </div>
                            </div>
