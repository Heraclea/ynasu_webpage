<div class="container into-auth">
    <div class="col-md-4 col-md-offset-4">
        <div class="card">
            <div class="header">
                <h4 class="title login"><img src="<?= base_url() ?>assets/images/logo.png" alt="HeraClea" width="200px"></h4>
            </div>
            <div class="content">
                <div class="row">
                    <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" class="form-control" placeholder="<?= $this->lang->line('user') ?>">
                            </div>        
                        </div>
                    </div>
